...
- [GitHub Automatic Releases](https://github.com/marketplace/actions/cbgh-automatic-releases) - automatically upload assets, generate changelogs, pre-releases, and so on.
